...
This project is developed as part of the **Course Code Challenge (CCC)** and demonstrates the application of **Greedy Algorithms** in solving real-world cache optimization problems.

---

## 👥 Team Members
- G. Sai Pravallika - AP24110010383
- N. Pranathi       - AP24110010392
- Y. Siri Priya     - AP24110010450
- Ch. Bindu Madhavi - AP24110010401
- K. Vyshnavi       - AP24110010432
...
In modern computing systems, cache memory is limited. When the cache becomes full, an efficient strategy is required to decide which items should be removed to make space for new data.

Traditional methods like FIFO and LRU do not consider all relevant factors such as size, frequency, and recency together.

This project solves the problem by applying a greedy approach that maximizes cache efficiency.
...
The objective of this project is to design and simulate an efficient cache management system using algorithmic techniques learned in class. The system focuses on optimizing cache performance by intelligently selecting which data to evict when memory is full.

---

## 📚 Concepts Used

- Greedy Algorithm ✅ (Primary concept)
- Optimization Techniques
- Data Structures (Maps, Priority Queue)
...
The complete detailed report can be accessed here:

[Download Project Report](docs/SmartCache_Report.pdf) 